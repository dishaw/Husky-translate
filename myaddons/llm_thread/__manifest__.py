...
Contact: support@apexive.com
    ...
    "assets": {
        "web.assets_backend": [
            # External libraries for math rendering
            ("include", "web._assets_helpers"),
            # KaTeX for LaTeX math rendering (from CDN)
            # Include both CSS and JS for proper styling and rendering
            # Note: Using UMD bundles for compatibility
            # CSS for styling
            # JS for rendering
            ...
            "llm_thread/static/src/utils/math_renderer.js",
            ...
            "llm_thread/static/src/patches/message_math_patch.js",
            "llm_thread/static/src/patches/message_table_patch.js",
            "llm_thread/static/src/patches/llm_table.scss",
